...
public class FreePreferencesService {
    ...
    public String getHubPassword() {
        ...
        if (!password.trim().isEmpty()) {
            ...
            if (passwordLength != null && !passwordLength.equals("")) {
                credentialsBuilder.setPasswordLength(Integer.parseInt(passwordLength));
            }
            final Credentials credentials = credentialsBuilder.buildObject();
            try {
                return credentials.getDecryptedPassword();
    ...
    public void saveHubServerConfig(final HubServerConfig hubServerConfig) throws EncryptionException {
        final Credentials hubCredentials = hubServerConfig.getGlobalCredentials();
